...
See the **`cmux-orchestrator` skill** (run orchestrator mode by asking to orchestrate / run sessions in parallel). The skill is the single source of truth and supersedes this section.
